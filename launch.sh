...
appdir="/mnt/SDCARD/App/CRTPlayer"
...
do
	...
	#(sleep 2 ; mv /mnt/SDCARD/App/CRTPlayer/pos.bck /mnt/SDCARD/CRTPlayer/pos.cfg ;) &
	...
	./bin/ffplay -autoexit -vf "hflip,vflip,drawgrid=w=iw:h=4:t=1:c=black@0.2,hue=s=1.4,vignette,noise=alls=7:allf=t,colorbalance=rs=0.05:gs=0.04:bs=-0.05" -i "$selected_file" $startTimer
	rm -f /tmp/stay_awake
done
